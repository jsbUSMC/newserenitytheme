...
(function (SereneMetronic) {
    ...
    (function (Northwind) {
        var TerritoryDialog = (function (_super) {
            ...
            TerritoryDialog.prototype.getLanguages = function () {
                return SereneMetronic.LanguageList.getValue();
            };
    ...
    })(Northwind = SereneMetronic.Northwind || (SereneMetronic.Northwind = {}));
})(SereneMetronic || (SereneMetronic = {}));
var SereneMetronic;
(function (SereneMetronic) {
    var Northwind;
    (function (Northwind) {
    ...
    (function (Northwind) {
        var ProductGrid = (function (_super) {
            ...
            ProductGrid.prototype.getButtons = function () {
                ...
                buttons.push(SereneMetronic.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    service: Northwind.ProductService.baseUrl + '/ListExcel',
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    separator: true
                }));
                buttons.push(SereneMetronic.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
...
(function (SereneMetronic) {
    ...
    })(Common = SereneMetronic.Common || (SereneMetronic.Common = {}));
})(SereneMetronic || (SereneMetronic = {}));
...
(function (SereneMetronic) {
    ...
    (function (Northwind) {
        ...
        }(SereneMetronic.Common.GridEditorDialog));
...
(function (SereneMetronic) {
    ...
    (function (Northwind) {
        ...
        }(SereneMetronic.Common.GridEditorBase));
    ...
    (function (Common) {
        var BulkServiceAction = (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new SereneMetronic.BasicProgressDialog();
...
(function (SereneMetronic) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneMetronic.Common.BulkServiceAction));
        BasicSamples.OrderBulkAction = OrderBulkAction;
    })(BasicSamples = SereneMetronic.BasicSamples || (SereneMetronic.BasicSamples = {}));
})(SereneMetronic || (SereneMetronic = {}));
var SereneMetronic;
(function (SereneMetronic) {
    var Northwind;
    (function (Northwind) {
        var OrderDialog = (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                ...
                buttons.push(SereneMetronic.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: SereneMetronic.Authorization.userDefinition.DisplayName,
    ...
    (function (Northwind) {
        var CustomerDialog = (function (_super) {
            ...
            function CustomerDialog() {
                ...
                SereneMetronic.DialogUtils.pendingChangesConfirmation(this.element, function () { return _this.getSaveState() != _this.loadedState; });
...
(function (SereneMetronic) {
    ...
    })(Membership = SereneMetronic.Membership || (SereneMetronic.Membership = {}));
})(SereneMetronic || (SereneMetronic = {}));
var SereneMetronic;
(function (SereneMetronic) {
    var Membership;
...
(function (SereneMetronic) {
    ...
    (function (ScriptInitialization) {
        ...
        Q.Config.rootNamespaces.push('SereneMetronic');
    })(ScriptInitialization = SereneMetronic.ScriptInitialization || (SereneMetronic.ScriptInitialization = {}));
})(SereneMetronic || (SereneMetronic = {}));
var SereneMetronic;
(function (SereneMetronic) {
    var Common;
...
(function (SereneMetronic) {
    ...
    })(Administration = SereneMetronic.Administration || (SereneMetronic.Administration = {}));
})(SereneMetronic || (SereneMetronic = {}));
var SereneMetronic;
(function (SereneMetronic) {
    var Administration;
...
(function (SereneMetronic) {
    ...
    (function (BasicSamples) {
        ...
        [['CustomerID', function () { return SereneMetronic.Northwind.CustomerEditor; }], ['OrderDate', function () { return Serenity.DateEditor; }], ['CategoryID', function () { return Serenity.LookupEditor; }], ['DetailList', function () { return BasicSamples.FilteredLookupDetailEditor; }]].forEach(function (x) { return Object.defineProperty(FilteredLookupInDetailForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = SereneMetronic.BasicSamples || (SereneMetronic.BasicSamples = {}));
})(SereneMetronic || (SereneMetronic = {}));
var SereneMetronic;
(function (SereneMetronic) {
...
(function (SereneMetronic) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnum(Gender, 'SereneMetronic.Northwind.Entities.Gender');
    })(Northwind = SereneMetronic.Northwind || (SereneMetronic.Northwind = {}));
})(SereneMetronic || (SereneMetronic = {}));
var SereneMetronic;
(function (SereneMetronic) {
...
(function (SereneMetronic) {
    ...
    SereneMetronic.BasicProgressDialog = BasicProgressDialog;
})(SereneMetronic || (SereneMetronic = {}));
var SereneMetronic;
(function (SereneMetronic) {
    var DialogUtils;
    ...
    })(DialogUtils = SereneMetronic.DialogUtils || (SereneMetronic.DialogUtils = {}));
})(SereneMetronic || (SereneMetronic = {}));
var SereneMetronic;
(function (SereneMetronic) {
    var Common;
...
(function (SereneMetronic) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = SereneMetronic.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = SereneMetronic.LanguageList || (SereneMetronic.LanguageList = {}));
})(SereneMetronic || (SereneMetronic = {}));
var SereneMetronic;
(function (SereneMetronic) {
    var Common;
...
(function (SereneMetronic) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return SereneMetronic.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return SereneMetronic.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return SereneMetronic.Northwind.SalesByCategoryService.baseUrl; };
            /**
...
(function (SereneMetronic) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneMetronic.Northwind.SupplierGrid));
...
(function (SereneMetronic) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return SereneMetronic.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return SereneMetronic.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return SereneMetronic.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return SereneMetronic.Northwind.ProductService.baseUrl; };
    ...
    (function (BasicSamples) {
        var InitialValuesForQuickFilters = (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                var fld = SereneMetronic.Northwind.OrderRow.Fields;
                ...
                Q.first(filters, function (x) { return x.field == fld.ShippingState; }).init = function (w) {
                    ...
                    w.value = SereneMetronic.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
        ...
        }(SereneMetronic.Northwind.OrderGrid));
...
(function (SereneMetronic) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneMetronic.Northwind.ProductGrid));
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(SereneMetronic.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new SereneMetronic.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new SereneMetronic.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new SereneMetronic.Northwind.OrderDialog().loadEntityAndOpenDialog({
                    ...
                    var countryFilter = this.findQuickFilter(Serenity.LookupEditor, SereneMetronic.Northwind.OrderRow.Fields.ShipCountry);
...
(function (SereneMetronic) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return SereneMetronic.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return SereneMetronic.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return SereneMetronic.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return SereneMetronic.Northwind.ProductService.baseUrl; };
            /**
            ...
            ConditionalFormattingGrid.prototype.getColumns = function () {
                var columns = _super.prototype.getColumns.call(this);
                var fld = SereneMetronic.Northwind.ProductRow.Fields;
...
(function (SereneMetronic) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneMetronic.Northwind.ProductDialog));
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return SereneMetronic.Northwind.CategoryRow.lookupKey;
            };
            /**
...
(function (SereneMetronic) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneMetronic.Northwind.OrderDetailsEditor));
...
(function (SereneMetronic) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return SereneMetronic.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return SereneMetronic.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return SereneMetronic.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return SereneMetronic.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                _super.call(this);
                this.form = new SereneMetronic.Northwind.OrderDetailForm(this.idPrefix);
                ...
                this.form.ProductID.cascadeField = SereneMetronic.Northwind.ProductRow.Fields.CategoryID;
        ...
        }(SereneMetronic.Northwind.OrderDetailDialog));
...
(function (SereneMetronic) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return SereneMetronic.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return SereneMetronic.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return SereneMetronic.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return SereneMetronic.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return SereneMetronic.Northwind.OrderService.baseUrl; };
...
(function (SereneMetronic) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneMetronic.Northwind.OrderDialog));
...
(function (SereneMetronic) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew) {
                    ...
                    SereneMetronic.Northwind.CategoryService.Retrieve({
        ...
        }(SereneMetronic.Northwind.CategoryDialog));
...
(function (SereneMetronic) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneMetronic.Northwind.CategoryGrid));
        ...
        var DefaultValuesInNewGrid = (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: SereneMetronic.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: SereneMetronic.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new SereneMetronic.Northwind.OrderDialog();
                        ...
                        var chai = SereneMetronic.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = SereneMetronic.Northwind.EmployeeRow.getLookup().items
...
(function (SereneMetronic) {
    ...
    })(Authorization = SereneMetronic.Authorization || (SereneMetronic.Authorization = {}));
})(SereneMetronic || (SereneMetronic = {}));
var SereneMetronic;
(function (SereneMetronic) {
    var Administration;
...
//# sourceMappingURL=SereneMetronic.Web.js.map